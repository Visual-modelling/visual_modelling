...
#SBATCH -c 4
#SBATCH --gres=gpu:1
#SBATCH -o /home2/crhf63/kable_management/projects/Visual-modelling/cnn_visual_modelling/.results/transformer_focal-mean.out
...
python ../../../../main.py \
    ...
    --n_gifs 5 \
    --self_output_n 30 \
    --jobname poc_95-5_transformer_focal_mean \
    --loss focal \
    --reduction mean \
    --img_type greyscale \
    --model transformer \
