...
#SBATCH --job-name=trnsfrmr_99-1_og_sl1_mean
#SBATCH --ntasks=6
#SBATCH --gres=gpu:1
#SBATCH -o /home/jumperkables/kable_management/projects/Visual-modelling/cnn_visual_modelling/.results/trnsfrmr_99-1_og_sl1_d3_mean.out
...
python ../../../../../main.py \
    ...
    --n_gifs 3 \
    --self_output_n 30 \
    --jobname vm_trnsfrmr_99-1_og_sl1_d3_mean \
    --loss smooth_l1 \
    --reduction mean \
    --img_type greyscale \
    --model transformer \
