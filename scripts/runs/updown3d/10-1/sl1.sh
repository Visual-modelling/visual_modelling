...
#SBATCH --job-name=ud3d_99-1_multi_sl1_mean
#SBATCH --ntasks=6
#SBATCH --gres=gpu:1
#SBATCH -o /home/jumperkables/kable_management/projects/Visual-modelling/cnn_visual_modelling/.results/ud3d_99-1_multi_sl1_d3_mean.out
...
python ../../../../main.py \
    ...
    --padding 1 \
    --padding_t 2 \
    --jobname vm_ud3d_99-1_multi_sl1_d3_mean \
    --loss smooth_l1 \
    --reduction mean \
    --img_type greyscale \
    --model UpDown3D \
