...
#SBATCH --job-name mmnist_transformer_lr3e-6_ssim_021 
#SBATCH --gres gpu:1 
#SBATCH -o ../../../../../.results/mmnist_transformer_lr3e-6_ssim_021.out
cd ../../../../..
source python_venvs/vm/bin/activate
export PYTHONBREAKPOINT=ipdb.set_trace
python VM_train.py \
    --disable_preload \
    --test_only_model_path 'IT/mmnist_transformer_lr3e-6_ssim_021-epoch=28.ckpt' \
    --dataset simulations \
