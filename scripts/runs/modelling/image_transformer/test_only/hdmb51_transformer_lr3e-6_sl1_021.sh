...
#SBATCH --job-name hdmb51_transformer_lr3e-6_sl1_021 
#SBATCH --gres gpu:1 
#SBATCH -o ../../../../../.results/hdmb51_transformer_lr3e-6_sl1_021.out
cd ../../../../..
source python_venvs/vm/bin/activate
export PYTHONBREAKPOINT=ipdb.set_trace
python VM_train.py \
    --disable_preload \
    --test_only_model_path 'IT/hdmb51_transformer_lr3e-6_sl1_021-epoch=318.ckpt' \
    --dataset simulations \
