...
#SBATCH --job-name moon_transformer_lr1e-5_sl1_021 
#SBATCH --gres gpu:1 
#SBATCH -o ../../../../../.results/moon_transformer_lr1e-5_sl1_021.out
cd ../../../../..
source python_venvs/vm/bin/activate
export PYTHONBREAKPOINT=ipdb.set_trace
python VM_train.py \
    --disable_preload \
    --test_only_model_path 'moon_transformer_lr1e-5_sl1_021-epoch=499.ckpt' \
    --dataset simulations \
