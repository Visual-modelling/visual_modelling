...
#SBATCH --job-name mocap_transformer_lr1e-5_ssim_021 
#SBATCH --gres gpu:1 
#SBATCH -o ../../../../../.results/mocap_transformer_lr1e-5_ssim_021.out
cd ../../../../..
source python_venvs/vm/bin/activate
export PYTHONBREAKPOINT=ipdb.set_trace
python VM_train.py \
    --disable_preload \
    --test_only_model_path 'IT/mocap_transformer_lr1e-5_ssim_021-epoch=205.ckpt' \
    --dataset simulations \
