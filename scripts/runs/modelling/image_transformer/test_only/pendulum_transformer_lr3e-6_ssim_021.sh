...
#SBATCH --job-name pendulum_transformer_lr3e-6_ssim_021 
#SBATCH --gres gpu:1 
#SBATCH -o ../../../../../.results/pendulum_transformer_lr3e-6_ssim_021.out
cd ../../../../..
source python_venvs/vm/bin/activate
export PYTHONBREAKPOINT=ipdb.set_trace
python VM_train.py \
    --disable_preload \
    --test_only_model_path 'IT/pendulum_transformer_lr3e-6_ssim_021-epoch=138.ckpt' \
    --dataset simulations \
