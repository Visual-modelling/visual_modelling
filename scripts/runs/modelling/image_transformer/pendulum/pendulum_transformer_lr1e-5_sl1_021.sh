...
#SBATCH --job-name pendulum_transformer_lr1e-5_sl1_021 
#SBATCH --gres gpu:1 
#SBATCH -o ../../../../../.results/pendulum_transformer_lr1e-5_sl1_021.out
cd ../../../../..
...
python VM_train.py \
    ...
    --jobname pendulum_transformer_lr1e-5_sl1_021 \
