...
#SBATCH --job-name 3dBouncing_transformer_lr3e-6_ssim_021 
#SBATCH --gres gpu:1 
#SBATCH -o ../../../../../.results/3dBouncing_transformer_lr3e-6_ssim_021.out
cd ../../../../..
...
python VM_train.py \
    ...
    --jobname 3dBouncing_transformer_lr3e-6_ssim_021 \
