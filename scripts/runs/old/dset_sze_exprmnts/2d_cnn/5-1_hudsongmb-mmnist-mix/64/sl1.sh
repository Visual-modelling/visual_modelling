...
#SBATCH --ntasks 6
#SBATCH -p part0
#SBATCH --job-name varysize-64_mixed_2d-d3_sl1-mean
#SBATCH --gres gpu:1
#SBATCH -o /home/jumperkables/kable_management/projects/Visual-modelling/cnn_visual_modelling/.results/varysize-64_mixed_2d-d3_sl1-mean.out
...
python ../../../../../../VM_train.py \
    ...
    --n_gifs 16 \
    --self_output_n 100 \
    --jobname jmprkbls_varysize-64_5-1_mixed_2d-d3_sl1_mean \
    --loss smooth_l1 \
    --reduction mean \
    --img_type greyscale \
    --model UpDown2D \
