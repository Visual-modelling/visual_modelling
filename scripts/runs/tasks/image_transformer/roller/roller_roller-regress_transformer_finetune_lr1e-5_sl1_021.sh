...
#SBATCH --job-name roller_roller-regress_transformer_finetune_lr1e-5_sl1_021.sh
#SBATCH --gres gpu:1
#SBATCH -o ../../../../../.results/roller_roller-regress_transformer_finetune_lr1e-5_sl1_021.out
cd ../../../../..
...
python test_tasks.py \
    ...
    --jobname roller_roller-regress_transformer_finetune_lr1e-5_sl1_021 \
    --dataset simulations \
