...
#SBATCH --job-name roller_roller-regress_transformer_lr3e-7_sl1_021.sh
#SBATCH --gres gpu:1
#SBATCH -o ../../../../../.results/roller_roller-regress_transformer_lr3e-7_sl1_021.out
cd ../../../../..
...
python test_tasks.py \
    ...
    --linear_probes \
    --encoder_freeze \
    --jobname roller_roller-regress_transformer_lr3e-7_sl1_021 \
    --dataset simulations \
