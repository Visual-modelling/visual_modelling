...
#SBATCH --job-name 3dBouncing_bounces-regress_transformer_99in_lr1e-7_ssim_021.sh
#SBATCH --gres gpu:1
#SBATCH -o ../../../../../.results/3dBouncing_bounces-regress_transformer_99in_lr1e-7_ssim_021.out
cd ../../../../..
...
python test_tasks.py \
    ...
    --linear_probes \
    --encoder_freeze \
    --jobname 3dBouncing_bounces-regress_transformer_99in_lr1e-7_ssim_021 \
    --dataset simulations \
