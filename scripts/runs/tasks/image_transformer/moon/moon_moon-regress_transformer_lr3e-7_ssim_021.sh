...
#SBATCH --job-name moon_moon-regress_transformer_lr3e-7_ssim_021.sh
#SBATCH --gres gpu:1
#SBATCH -o ../../../../../.results/moon_moon-regress_transformer_lr3e-7_ssim_021.out
cd ../../../../..
...
python test_tasks.py \
    ...
    --linear_probes \
    --encoder_freeze \
    --jobname moon_moon-regress_transformer_lr3e-7_ssim_021 \
    --dataset simulations \
