...
#SBATCH --job-name moon_moon-regress_transformer_finetune_lr1e-5_sl1_021.sh
#SBATCH --gres gpu:1
#SBATCH -o ../../../../../.results/moon_moon-regress_transformer_finetune_lr1e-5_sl1_021.out
cd ../../../../..
...
python test_tasks.py \
    ...
    --jobname moon_moon-regress_transformer_finetune_lr1e-5_sl1_021 \
    --dataset simulations \
