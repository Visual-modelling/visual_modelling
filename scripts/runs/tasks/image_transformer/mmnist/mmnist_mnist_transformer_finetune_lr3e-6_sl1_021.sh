...
#SBATCH --job-name mmnist_mnist_transformer_finetune_lr3e-6_sl1_021.sh
#SBATCH --gres gpu:1
#SBATCH -o ../../../../../.results/mmnist_mnist_transformer_finetune_lr3e-6_sl1_021.out
cd ../../../../..
...
python test_tasks.py \
    ...
    --jobname mmnist_mnist_transformer_finetune_lr3e-6_sl1_021 \
    --dataset simulations \
