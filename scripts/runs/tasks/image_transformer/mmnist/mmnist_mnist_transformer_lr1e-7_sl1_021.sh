...
#SBATCH --job-name mmnist_mnist_transformer_lr1e-7_sl1_021.sh
#SBATCH --gres gpu:1
#SBATCH -o ../../../../../.results/mmnist_mnist_transformer_lr1e-7_sl1_021.out
cd ../../../../..
...
python test_tasks.py \
    ...
    --linear_probes \
    --encoder_freeze \
    --jobname mmnist_mnist_transformer_lr1e-7_sl1_021 \
    --dataset simulations \
