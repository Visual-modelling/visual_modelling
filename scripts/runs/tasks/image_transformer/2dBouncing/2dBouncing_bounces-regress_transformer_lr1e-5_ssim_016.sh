...
#SBATCH --job-name 2dBouncing_bounces-regress_transformer_lr1e-5_ssim_016.sh
#SBATCH --gres gpu:1
#SBATCH -o ../../../../../.results/2dBouncing_bounces-regress_transformer_lr1e-5_ssim_016.out
cd ../../../../..
...
python test_tasks.py \
    ...
    --linear_probes \
    --encoder_freeze \
    --jobname 2dBouncing_bounces-regress_transformer_lr1e-5_ssim_016 \
    --dataset simulations \
