...
#SBATCH --job-name blocks_blocks-regress_transformer_lr1e-7_sl1_021.sh
#SBATCH --gres gpu:1
#SBATCH -o ../../../../../.results/blocks_blocks-regress_transformer_lr1e-7_sl1_021.out
cd ../../../../..
...
python test_tasks.py \
    ...
    --linear_probes \
    --encoder_freeze \
    --jobname blocks_blocks-regress_transformer_lr1e-7_sl1_021 \
    --dataset simulations \
